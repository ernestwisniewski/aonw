use aonw_domain::{
    DiplomacyStateBuildError, GameState, GameStateBuildError, HexCoord, HexGridBounds, PlayerId,
    StateRevision, TurnLifecycleBuildError, UnitId, UnitOccupancyPolicy,
};
