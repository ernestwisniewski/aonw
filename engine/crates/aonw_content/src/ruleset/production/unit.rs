...
pub(super) const STANDARD_UNITS: [UnitProductionDefinition; 17] = [
    definition(Unit::Commander, 54, 0, NONE, NO_STOCKPILE_COST),
    definition(Unit::Warrior, 15, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Archer, 16, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Settler, 22, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Worker, 14, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Merchant, 24, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Scout, 12, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Spearman, 18, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Cavalry, 38, 2, HORSES, NO_STOCKPILE_COST),
    definition(Unit::Catapult, 40, 2, NONE, NO_STOCKPILE_COST),
    definition(Unit::HeavyInfantry, 46, 2, IRON, NO_STOCKPILE_COST),
    definition(Unit::FieldCannon, 58, 2, IRON, NO_STOCKPILE_COST),
    definition(Unit::Rifleman, 52, 2, IRON, NO_STOCKPILE_COST),
    definition(Unit::Tank, 84, 3, NONE, OIL_TWO),
    definition(Unit::ScoutShip, 34, 1, NONE, NO_STOCKPILE_COST),
    definition(Unit::Warship, 70, 2, IRON, NO_STOCKPILE_COST),
    definition(Unit::ReconPlane, 62, 2, NONE, ALUMINIUM_OR_OIL),
];
