...
pub use canonical::{
    ...
    IntendedAttackDto, InteractionStateDto, MapObjectiveHoldStateDto, MatchIdentityDto,
    MatchRulesDto, MerchantTradeRouteDto, PaceProfileDto, ParticipantDto, PendingInteractionDto,
    PlayerCountryDto, PlayerFogDto, PlayerKindDto, PlayerPairDto, PlayerResearchStateDto,
    PlayerTurnStateDto, ResearchStateDto, ResourceTradeAgreementDto, ResourceTypeDto, RuleValueDto,
