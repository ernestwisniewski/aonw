...
pub use canonical::{
    ...
    CoordinateDto, DiplomacyStateDto, DiplomaticMessageCategoryDto, DiplomaticMessageDto,
    ...
    PlayerPairDto, PlayerResearchStateDto, PlayerTurnStateDto, ResearchStateDto,
    ...
    VictoryRulesDto, WonderRegistryDto, WonderTypeDto, WorkerJobDto, WorldArtifactDto,
