...
fn artifact_commands_are_current_only_and_strict() {
    let legacy = r#"{"apiVersion":5,"request":{"type":"dispatch","command":{"type":"tradeArtifact","expectedRevision":10,"actorPlayerId":"player-1","targetPlayerId":"player-2","offeredArtifactId":"artifact-1","offeredGold":0,"requestedGold":4}}}"#;
