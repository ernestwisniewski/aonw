...
mixin _$GameState {
 ...
 Map<String, int> get playerColors; Map<String, PlayerCountry> get playerCountries; Map<String, int> get playerGold; Map<String, int> get playerWarWeariness; Map<String, int> get playerStabilityNet; List<GameUnit> get units; List<GameCity> get cities; List<WorldArtifact> get artifacts; List<FieldImprovement> get fieldImprovements; FogOfWarState get fogOfWar; ResearchState get research; WonderRegistry get wonderRegistry; DiplomacyState get diplomacy; List<IntendedAttack> get intendedAttacks; List<ResourceTradeAgreement> get resourceTradeAgreements; Map<String, int> get dominationHoldTurnsByPlayerId; Map<String, int> get culturalVictoryHoldTurnsByPlayerId; Map<String, MapObjectiveHoldState> get mapObjectiveHoldStatesByObjectiveId; String get activePlayerId; bool get activePlayerCanAct; Set<String> get submittedPlayerIds; Map<String, int> get timeoutStreaksByPlayerId; Set<String> get afkPlayerIds; Set<String> get kickedPlayerIds; DateTime? get turnStartedAt; GameInteractionState get interaction;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is GameState&&const DeepCollectionEquality().equals(other.playerColors, playerColors)&&const DeepCollectionEquality().equals(other.playerCountries, playerCountries)&&const DeepCollectionEquality().equals(other.playerGold, playerGold)&&const DeepCollectionEquality().equals(other.playerWarWeariness, playerWarWeariness)&&const DeepCollectionEquality().equals(other.playerStabilityNet, playerStabilityNet)&&const DeepCollectionEquality().equals(other.units, units)&&const DeepCollectionEquality().equals(other.cities, cities)&&const DeepCollectionEquality().equals(other.artifacts, artifacts)&&const DeepCollectionEquality().equals(other.fieldImprovements, fieldImprovements)&&(identical(other.fogOfWar, fogOfWar) || other.fogOfWar == fogOfWar)&&(identical(other.research, research) || other.research == research)&&(identical(other.wonderRegistry, wonderRegistry) || other.wonderRegistry == wonderRegistry)&&(identical(other.diplomacy, diplomacy) || other.diplomacy == diplomacy)&&const DeepCollectionEquality().equals(other.intendedAttacks, intendedAttacks)&&const DeepCollectionEquality().equals(other.resourceTradeAgreements, resourceTradeAgreements)&&const DeepCollectionEquality().equals(other.dominationHoldTurnsByPlayerId, dominationHoldTurnsByPlayerId)&&const DeepCollectionEquality().equals(other.culturalVictoryHoldTurnsByPlayerId, culturalVictoryHoldTurnsByPlayerId)&&const DeepCollectionEquality().equals(other.mapObjectiveHoldStatesByObjectiveId, mapObjectiveHoldStatesByObjectiveId)&&(identical(other.activePlayerId, activePlayerId) || other.activePlayerId == activePlayerId)&&(identical(other.activePlayerCanAct, activePlayerCanAct) || other.activePlayerCanAct == activePlayerCanAct)&&const DeepCollectionEquality().equals(other.submittedPlayerIds, submittedPlayerIds)&&const DeepCollectionEquality().equals(other.timeoutStreaksByPlayerId, timeoutStreaksByPlayerId)&&const DeepCollectionEquality().equals(other.afkPlayerIds, afkPlayerIds)&&const DeepCollectionEquality().equals(other.kickedPlayerIds, kickedPlayerIds)&&(identical(other.turnStartedAt, turnStartedAt) || other.turnStartedAt == turnStartedAt)&&(identical(other.interaction, interaction) || other.interaction == interaction));
}


@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(playerColors),const DeepCollectionEquality().hash(playerCountries),const DeepCollectionEquality().hash(playerGold),const DeepCollectionEquality().hash(playerWarWeariness),const DeepCollectionEquality().hash(playerStabilityNet),const DeepCollectionEquality().hash(units),const DeepCollectionEquality().hash(cities),const DeepCollectionEquality().hash(artifacts),const DeepCollectionEquality().hash(fieldImprovements),fogOfWar,research,wonderRegistry,diplomacy,const DeepCollectionEquality().hash(intendedAttacks),const DeepCollectionEquality().hash(resourceTradeAgreements),const DeepCollectionEquality().hash(dominationHoldTurnsByPlayerId),const DeepCollectionEquality().hash(culturalVictoryHoldTurnsByPlayerId),const DeepCollectionEquality().hash(mapObjectiveHoldStatesByObjectiveId),activePlayerId,activePlayerCanAct,const DeepCollectionEquality().hash(submittedPlayerIds),const DeepCollectionEquality().hash(timeoutStreaksByPlayerId),const DeepCollectionEquality().hash(afkPlayerIds),const DeepCollectionEquality().hash(kickedPlayerIds),turnStartedAt,interaction]);

@override
String toString() {
  return 'GameState(playerColors: $playerColors, playerCountries: $playerCountries, playerGold: $playerGold, playerWarWeariness: $playerWarWeariness, playerStabilityNet: $playerStabilityNet, units: $units, cities: $cities, artifacts: $artifacts, fieldImprovements: $fieldImprovements, fogOfWar: $fogOfWar, research: $research, wonderRegistry: $wonderRegistry, diplomacy: $diplomacy, intendedAttacks: $intendedAttacks, resourceTradeAgreements: $resourceTradeAgreements, dominationHoldTurnsByPlayerId: $dominationHoldTurnsByPlayerId, culturalVictoryHoldTurnsByPlayerId: $culturalVictoryHoldTurnsByPlayerId, mapObjectiveHoldStatesByObjectiveId: $mapObjectiveHoldStatesByObjectiveId, activePlayerId: $activePlayerId, activePlayerCanAct: $activePlayerCanAct, submittedPlayerIds: $submittedPlayerIds, timeoutStreaksByPlayerId: $timeoutStreaksByPlayerId, afkPlayerIds: $afkPlayerIds, kickedPlayerIds: $kickedPlayerIds, turnStartedAt: $turnStartedAt, interaction: $interaction)';
}
...
@useResult
$Res call({
 Map<String, int> playerColors, Map<String, PlayerCountry> playerCountries, Map<String, int> playerGold, Map<String, int> playerWarWeariness, Map<String, int> playerStabilityNet, List<GameUnit> units, List<GameCity> cities, List<WorldArtifact> artifacts, List<FieldImprovement> fieldImprovements, FogOfWarState fogOfWar, ResearchState research, WonderRegistry wonderRegistry, DiplomacyState diplomacy, List<IntendedAttack> intendedAttacks, List<ResourceTradeAgreement> resourceTradeAgreements, Map<String, int> dominationHoldTurnsByPlayerId, Map<String, int> culturalVictoryHoldTurnsByPlayerId, Map<String, MapObjectiveHoldState> mapObjectiveHoldStatesByObjectiveId, String activePlayerId, bool activePlayerCanAct, Set<String> submittedPlayerIds, Map<String, int> timeoutStreaksByPlayerId, Set<String> afkPlayerIds, Set<String> kickedPlayerIds, DateTime? turnStartedAt, GameInteractionState interaction
});
...
/// Create a copy of GameState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? playerColors = null,Object? playerCountries = null,Object? playerGold = null,Object? playerWarWeariness = null,Object? playerStabilityNet = null,Object? units = null,Object? cities = null,Object? artifacts = null,Object? fieldImprovements = null,Object? fogOfWar = null,Object? research = null,Object? wonderRegistry = null,Object? diplomacy = null,Object? intendedAttacks = null,Object? resourceTradeAgreements = null,Object? dominationHoldTurnsByPlayerId = null,Object? culturalVictoryHoldTurnsByPlayerId = null,Object? mapObjectiveHoldStatesByObjectiveId = null,Object? activePlayerId = null,Object? activePlayerCanAct = null,Object? submittedPlayerIds = null,Object? timeoutStreaksByPlayerId = null,Object? afkPlayerIds = null,Object? kickedPlayerIds = null,Object? turnStartedAt = freezed,Object? interaction = null,}) {
  return _then(_self.copyWith(
...
as Map<String, int>,playerWarWeariness: null == playerWarWeariness ? _self.playerWarWeariness : playerWarWeariness // ignore: cast_nullable_to_non_nullable
as Map<String, int>,playerStabilityNet: null == playerStabilityNet ? _self.playerStabilityNet : playerStabilityNet // ignore: cast_nullable_to_non_nullable
...
as ResearchState,wonderRegistry: null == wonderRegistry ? _self.wonderRegistry : wonderRegistry // ignore: cast_nullable_to_non_nullable
as WonderRegistry,diplomacy: null == diplomacy ? _self.diplomacy : diplomacy // ignore: cast_nullable_to_non_nullable
...
as Set<String>,turnStartedAt: freezed == turnStartedAt ? _self.turnStartedAt : turnStartedAt // ignore: cast_nullable_to_non_nullable
as DateTime?,interaction: null == interaction ? _self.interaction : interaction // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( Map<String, int> playerColors,  Map<String, PlayerCountry> playerCountries,  Map<String, int> playerGold,  Map<String, int> playerWarWeariness,  Map<String, int> playerStabilityNet,  List<GameUnit> units,  List<GameCity> cities,  List<WorldArtifact> artifacts,  List<FieldImprovement> fieldImprovements,  FogOfWarState fogOfWar,  ResearchState research,  WonderRegistry wonderRegistry,  DiplomacyState diplomacy,  List<IntendedAttack> intendedAttacks,  List<ResourceTradeAgreement> resourceTradeAgreements,  Map<String, int> dominationHoldTurnsByPlayerId,  Map<String, int> culturalVictoryHoldTurnsByPlayerId,  Map<String, MapObjectiveHoldState> mapObjectiveHoldStatesByObjectiveId,  String activePlayerId,  bool activePlayerCanAct,  Set<String> submittedPlayerIds,  Map<String, int> timeoutStreaksByPlayerId,  Set<String> afkPlayerIds,  Set<String> kickedPlayerIds,  DateTime? turnStartedAt,  GameInteractionState interaction)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _GameState() when $default != null:
return $default(_that.playerColors,_that.playerCountries,_that.playerGold,_that.playerWarWeariness,_that.playerStabilityNet,_that.units,_that.cities,_that.artifacts,_that.fieldImprovements,_that.fogOfWar,_that.research,_that.wonderRegistry,_that.diplomacy,_that.intendedAttacks,_that.resourceTradeAgreements,_that.dominationHoldTurnsByPlayerId,_that.culturalVictoryHoldTurnsByPlayerId,_that.mapObjectiveHoldStatesByObjectiveId,_that.activePlayerId,_that.activePlayerCanAct,_that.submittedPlayerIds,_that.timeoutStreaksByPlayerId,_that.afkPlayerIds,_that.kickedPlayerIds,_that.turnStartedAt,_that.interaction);case _:
  return orElse();
...
class _GameState extends GameState {
  const _GameState({final  Map<String, int> playerColors = const {}, final  Map<String, PlayerCountry> playerCountries = const {}, final  Map<String, int> playerGold = const {}, final  Map<String, int> playerWarWeariness = const {}, final  Map<String, int> playerStabilityNet = const {}, final  List<GameUnit> units = const [], final  List<GameCity> cities = const [], final  List<WorldArtifact> artifacts = const [], final  List<FieldImprovement> fieldImprovements = const [], this.fogOfWar = FogOfWarState.empty, this.research = ResearchState.empty, this.wonderRegistry = WonderRegistry.empty, this.diplomacy = DiplomacyState.empty, final  List<IntendedAttack> intendedAttacks = const [], final  List<ResourceTradeAgreement> resourceTradeAgreements = const [], final  Map<String, int> dominationHoldTurnsByPlayerId = const {}, final  Map<String, int> culturalVictoryHoldTurnsByPlayerId = const {}, final  Map<String, MapObjectiveHoldState> mapObjectiveHoldStatesByObjectiveId = const {}, this.activePlayerId = '', this.activePlayerCanAct = true, final  Set<String> submittedPlayerIds = const {}, final  Map<String, int> timeoutStreaksByPlayerId = const {}, final  Set<String> afkPlayerIds = const {}, final  Set<String> kickedPlayerIds = const {}, this.turnStartedAt, this.interaction = GameInteractionState.empty}): _playerColors = playerColors,_playerCountries = playerCountries,_playerGold = playerGold,_playerWarWeariness = playerWarWeariness,_playerStabilityNet = playerStabilityNet,_units = units,_cities = cities,_artifacts = artifacts,_fieldImprovements = fieldImprovements,_intendedAttacks = intendedAttacks,_resourceTradeAgreements = resourceTradeAgreements,_dominationHoldTurnsByPlayerId = dominationHoldTurnsByPlayerId,_culturalVictoryHoldTurnsByPlayerId = culturalVictoryHoldTurnsByPlayerId,_mapObjectiveHoldStatesByObjectiveId = mapObjectiveHoldStatesByObjectiveId,_submittedPlayerIds = submittedPlayerIds,_timeoutStreaksByPlayerId = timeoutStreaksByPlayerId,_afkPlayerIds = afkPlayerIds,_kickedPlayerIds = kickedPlayerIds,super._();
...
@override@JsonKey() Map<String, int> get playerGold {
 ...
 final  Map<String, int> _playerWarWeariness;
@override@JsonKey() Map<String, int> get playerWarWeariness {
  if (_playerWarWeariness is EqualUnmodifiableMapView) return _playerWarWeariness;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_playerWarWeariness);
}

 final  Map<String, int> _playerStabilityNet;
@override@JsonKey() Map<String, int> get playerStabilityNet {
  if (_playerStabilityNet is EqualUnmodifiableMapView) return _playerStabilityNet;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableMapView(_playerStabilityNet);
}
...
@override@JsonKey() final  WonderRegistry wonderRegistry;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _GameState&&const DeepCollectionEquality().equals(other._playerColors, _playerColors)&&const DeepCollectionEquality().equals(other._playerCountries, _playerCountries)&&const DeepCollectionEquality().equals(other._playerGold, _playerGold)&&const DeepCollectionEquality().equals(other._playerWarWeariness, _playerWarWeariness)&&const DeepCollectionEquality().equals(other._playerStabilityNet, _playerStabilityNet)&&const DeepCollectionEquality().equals(other._units, _units)&&const DeepCollectionEquality().equals(other._cities, _cities)&&const DeepCollectionEquality().equals(other._artifacts, _artifacts)&&const DeepCollectionEquality().equals(other._fieldImprovements, _fieldImprovements)&&(identical(other.fogOfWar, fogOfWar) || other.fogOfWar == fogOfWar)&&(identical(other.research, research) || other.research == research)&&(identical(other.wonderRegistry, wonderRegistry) || other.wonderRegistry == wonderRegistry)&&(identical(other.diplomacy, diplomacy) || other.diplomacy == diplomacy)&&const DeepCollectionEquality().equals(other._intendedAttacks, _intendedAttacks)&&const DeepCollectionEquality().equals(other._resourceTradeAgreements, _resourceTradeAgreements)&&const DeepCollectionEquality().equals(other._dominationHoldTurnsByPlayerId, _dominationHoldTurnsByPlayerId)&&const DeepCollectionEquality().equals(other._culturalVictoryHoldTurnsByPlayerId, _culturalVictoryHoldTurnsByPlayerId)&&const DeepCollectionEquality().equals(other._mapObjectiveHoldStatesByObjectiveId, _mapObjectiveHoldStatesByObjectiveId)&&(identical(other.activePlayerId, activePlayerId) || other.activePlayerId == activePlayerId)&&(identical(other.activePlayerCanAct, activePlayerCanAct) || other.activePlayerCanAct == activePlayerCanAct)&&const DeepCollectionEquality().equals(other._submittedPlayerIds, _submittedPlayerIds)&&const DeepCollectionEquality().equals(other._timeoutStreaksByPlayerId, _timeoutStreaksByPlayerId)&&const DeepCollectionEquality().equals(other._afkPlayerIds, _afkPlayerIds)&&const DeepCollectionEquality().equals(other._kickedPlayerIds, _kickedPlayerIds)&&(identical(other.turnStartedAt, turnStartedAt) || other.turnStartedAt == turnStartedAt)&&(identical(other.interaction, interaction) || other.interaction == interaction));
}


@override
int get hashCode => Object.hashAll([runtimeType,const DeepCollectionEquality().hash(_playerColors),const DeepCollectionEquality().hash(_playerCountries),const DeepCollectionEquality().hash(_playerGold),const DeepCollectionEquality().hash(_playerWarWeariness),const DeepCollectionEquality().hash(_playerStabilityNet),const DeepCollectionEquality().hash(_units),const DeepCollectionEquality().hash(_cities),const DeepCollectionEquality().hash(_artifacts),const DeepCollectionEquality().hash(_fieldImprovements),fogOfWar,research,wonderRegistry,diplomacy,const DeepCollectionEquality().hash(_intendedAttacks),const DeepCollectionEquality().hash(_resourceTradeAgreements),const DeepCollectionEquality().hash(_dominationHoldTurnsByPlayerId),const DeepCollectionEquality().hash(_culturalVictoryHoldTurnsByPlayerId),const DeepCollectionEquality().hash(_mapObjectiveHoldStatesByObjectiveId),activePlayerId,activePlayerCanAct,const DeepCollectionEquality().hash(_submittedPlayerIds),const DeepCollectionEquality().hash(_timeoutStreaksByPlayerId),const DeepCollectionEquality().hash(_afkPlayerIds),const DeepCollectionEquality().hash(_kickedPlayerIds),turnStartedAt,interaction]);
...
/// Create a copy of GameState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? playerColors = null,Object? playerCountries = null,Object? playerGold = null,Object? playerWarWeariness = null,Object? playerStabilityNet = null,Object? units = null,Object? cities = null,Object? artifacts = null,Object? fieldImprovements = null,Object? fogOfWar = null,Object? research = null,Object? wonderRegistry = null,Object? diplomacy = null,Object? intendedAttacks = null,Object? resourceTradeAgreements = null,Object? dominationHoldTurnsByPlayerId = null,Object? culturalVictoryHoldTurnsByPlayerId = null,Object? mapObjectiveHoldStatesByObjectiveId = null,Object? activePlayerId = null,Object? activePlayerCanAct = null,Object? submittedPlayerIds = null,Object? timeoutStreaksByPlayerId = null,Object? afkPlayerIds = null,Object? kickedPlayerIds = null,Object? turnStartedAt = freezed,Object? interaction = null,}) {
...
as Map<String, int>,playerWarWeariness: null == playerWarWeariness ? _self._playerWarWeariness : playerWarWeariness // ignore: cast_nullable_to_non_nullable
as Map<String, int>,playerStabilityNet: null == playerStabilityNet ? _self._playerStabilityNet : playerStabilityNet // ignore: cast_nullable_to_non_nullable
