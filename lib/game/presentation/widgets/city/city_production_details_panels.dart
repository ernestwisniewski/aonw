...
class CityProductionWonderDetailsLayer extends StatelessWidget {
  const CityProductionWonderDetailsLayer({
    required this.item,
    required this.l10n,
    required this.definition,
    required this.unlockingTechnology,
  ...
  Widget build(BuildContext context) {
    return _CityProductionInlineDetailsLayer(
      compact: compact,
      childBuilder: (maxWidth, maxHeight) {
        return CityProductionWonderDetailsPanel(
          item: item,
          l10n: l10n,
          definition: definition,
          unlockingTechnology: unlockingTechnology,
...
class CityProductionWonderDetailsPanel extends StatelessWidget {
  const CityProductionWonderDetailsPanel({
    required this.item,
    required this.l10n,
    required this.definition,
    required this.unlockingTechnology,
