...
const REJECTION_CODES := [
	...
	"diplomacy_duplicate_message",
	"diplomacy_message_not_found",
	"diplomacy_message_unavailable",
	"diplomacy_truce_active",
	"diplomacy_war_already_active",
	"diplomacy_invalid_gold_amount",
	"diplomacy_gold_gift_blocked_by_relation",
	"diplomacy_gold_unavailable",
	"diplomacy_gold_gift_unavailable",
	"invalid_resource_trade_target",
	"invalid_resource_trade_resource",
	"invalid_resource_trade_terms",
	"resource_trade_blocked_by_war",
	"resource_trade_gold_unavailable",
	"resource_trade_already_active",
	"invalid_resource_trade_agreement_id",
	"resource_trade_agreement_id_conflict",
	"resource_trade_export_unavailable",
	"resource_trade_offer_unavailable",
	"resource_trade_request_unavailable",
	"artifact_trade_actor_unavailable",
	"artifact_trade_target_invalid",
	"artifact_trade_gold_invalid",
