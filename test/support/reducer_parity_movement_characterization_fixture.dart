...
DomainState _movementState(
  ...
  return source.copyWith(
    ...
    submittedPlayerIds: const {_movementOpponentId},
    timeoutStreaksByPlayerId: const {_movementOpponentId: 2},
    afkPlayerIds: const {_movementOpponentId},
    kickedPlayerIds: const {_movementOpponentId},
    intendedAttacks: const [
      IntendedAttack(
        ...
        defenderRow: 30,
        declaredAtTick: 41,
        declaringPlayerId: _movementOpponentId,
      ),
    ],
    diplomacy: diplomacy ?? _movementContactDiplomacy,
    dominationHoldTurnsByPlayerId: const {_movementOpponentId: 3},
    culturalVictoryHoldTurnsByPlayerId: const {_movementOpponentId: 4},
    mapObjectiveHoldStatesByObjectiveId: const {
      'sentinel_objective': MapObjectiveHoldState(
        objectiveId: 'sentinel_objective',
        playerId: _movementOpponentId,
        holdTurns: 2,
      ),
    },
