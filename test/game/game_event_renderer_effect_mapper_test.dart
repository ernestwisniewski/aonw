...
void main() {
  group('GameEventRendererEffectMapper', () {
    ...
    test('shows blue threat borders while focusing the fortified unit', () {
    ...
    test('keeps a fortification marker attached to the detected unit', () {
      final fortifier = GameUnit(
        id: 'guard_1',
        ownerPlayerId: 'player_1',
        type: GameUnitType.warrior,
      ...
      expect(alert.unitId, 'enemy');
      expect((alert.col, alert.row), (5, 4));
      expect(effects.last, isA<SmoothCameraEffect>());
    });

    test('fails closed when a fortification alert has no viewer identity', () {
      final fortifier = GameUnit(
        id: 'guard_1',
        ownerPlayerId: 'player_1',
        type: GameUnitType.warrior,
