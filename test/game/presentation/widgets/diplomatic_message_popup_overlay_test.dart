...
void main() {
  ...
  testWidgets('minimizes diplomatic message with gamepad before renderer', (
    tester,
  ) async {
    ...
    expect(
      container.read(hudMinimizedPopupsProvider).entries.single.kind,
      HudMinimizedPopupKind.diplomaticMessage,
    );
  });
