...
| [0004](0004-versioned-multiplayer-protocol.md) | Versioned multiplayer protocol | Superseded by [0006](0006-current-version-protocol.md) | In progress |
| [0005](0005-immutable-deployment.md) | Immutable deployment promotion | Accepted | In progress |
| [0006](0006-current-version-protocol.md) | Current-version protocol compatibility | Accepted | Implemented |
