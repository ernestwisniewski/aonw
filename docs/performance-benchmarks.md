...
| --- | --- | --- |
| Map lookup | 100, 1,000, and 10,000 tiles | resolve the first, middle, and last tile plus a missing coordinate through both `MapData` and `MapDefinition`; record actual list reads/tile inspections and output digests for both pre-refactor models |
