...
part 'support/realtime_match_hub_quickplay_scenarios.dart';
...
part 'support/realtime_match_hub_connection_scenarios.dart';
...
void main() {
  ...
  _registerRealtimeMatchHubQuickplayScenarios();
  ...
  _registerRealtimeMatchHubConnectionScenarios();
