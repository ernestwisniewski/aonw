...
--
-- Class ExternalAuthRequest as table aonw_external_auth_request
--
...
--
-- Class GameCommandLedger as table aonw_game_command_ledger
--
CREATE TABLE "aonw_game_command_ledger" (
    ...
    "requestJson" text,
    "recipientOutcomeJson" text NOT NULL,
    "createdAt" timestamp without time zone NOT NULL
);

-- Indexes
CREATE UNIQUE INDEX "aonw_game_command_idempotency_idx" ON "aonw_game_command_ledger" USING btree ("matchId", "playerId", "clientCommandId");
CREATE INDEX "aonw_game_command_offset_idx" ON "aonw_game_command_ledger" USING btree ("matchId", "finalEventOffset");

--
-- Class GameEvent as table aonw_game_event
--
CREATE TABLE "aonw_game_event" (
    "id" bigserial PRIMARY KEY,
    "matchId" bigint NOT NULL,
...
-- Indexes
CREATE UNIQUE INDEX "aonw_game_event_match_offset_idx" ON "aonw_game_event" USING btree ("matchId", "offset");

--
-- Class GameMatch as table aonw_game_match
--
CREATE TABLE "aonw_game_match" (
    "id" bigserial PRIMARY KEY,
    ...
    "mapDocument" text,
    "canonicalStateJson" text,
    "state" text NOT NULL,
    "turn" bigint NOT NULL,
    "startedAt" timestamp without time zone NOT NULL,
    "endedAt" timestamp without time zone,
    "outcomeCondition" text,
    "winnerPlayerId" text,
...
-- Indexes
CREATE UNIQUE INDEX "aonw_game_match_public_id_idx" ON "aonw_game_match" USING btree ("publicId");
CREATE INDEX "aonw_game_match_updated_idx" ON "aonw_game_match" USING btree ("updatedAt", "publicId");
CREATE INDEX "aonw_game_match_started_idx" ON "aonw_game_match" USING btree ("startedAt");
CREATE INDEX "aonw_game_match_ended_idx" ON "aonw_game_match" USING btree ("endedAt");

--
-- Class GameParticipant as table aonw_game_participant
--
CREATE TABLE "aonw_game_participant" (
    "id" bigserial PRIMARY KEY,
    "matchId" bigint NOT NULL,
...
-- Indexes
CREATE UNIQUE INDEX "aonw_game_participant_match_user_idx" ON "aonw_game_participant" USING btree ("matchId", "userIdentifier");
CREATE UNIQUE INDEX "aonw_game_participant_match_player_idx" ON "aonw_game_participant" USING btree ("matchId", "playerId");

--
-- Class GameRecipientSnapshot as table aonw_game_recipient_snapshot
--
CREATE TABLE "aonw_game_recipient_snapshot" (
    "id" bigserial PRIMARY KEY,
    "matchId" bigint NOT NULL,
    "playerId" text NOT NULL,
    "eventOffset" bigint NOT NULL,
...
-- Indexes
CREATE UNIQUE INDEX "aonw_game_recipient_snapshot_idx" ON "aonw_game_recipient_snapshot" USING btree ("matchId", "playerId");

--
-- Class SteamAccount as table aonw_steam_account
--
...
--
-- Class SteamAuthRequest as table aonw_steam_auth_request
--
...
--
-- Foreign relations for "aonw_game_command_ledger" table
--
ALTER TABLE ONLY "aonw_game_command_ledger"
    ADD CONSTRAINT "aonw_game_command_ledger_fk_0"
    FOREIGN KEY("matchId")
...
--
-- Foreign relations for "aonw_game_event" table
--
ALTER TABLE ONLY "aonw_game_event"
    ADD CONSTRAINT "aonw_game_event_fk_0"
    FOREIGN KEY("matchId")
    REFERENCES "aonw_game_match"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "aonw_game_participant" table
--
ALTER TABLE ONLY "aonw_game_participant"
    ADD CONSTRAINT "aonw_game_participant_fk_0"
    FOREIGN KEY("matchId")
    REFERENCES "aonw_game_match"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "aonw_game_recipient_snapshot" table
--
ALTER TABLE ONLY "aonw_game_recipient_snapshot"
    ADD CONSTRAINT "aonw_game_recipient_snapshot_fk_0"
    FOREIGN KEY("matchId")
    REFERENCES "aonw_game_match"("id")
    ON DELETE CASCADE
    ON UPDATE NO ACTION;
...
--
-- Foreign relations for "aonw_steam_account" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('aonw', '20260829235223419-initial-schema', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260829235223419-initial-schema', "timestamp" = now();
