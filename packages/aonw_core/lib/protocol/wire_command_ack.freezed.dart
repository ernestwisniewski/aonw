...
mixin _$WireCommandAck {
 ...
 int get v; String get matchId; bool get accepted; int get offset; WireSnapshot get snapshot; List<Map<String, dynamic>> get events; String? get reason;
...
@override
int get hashCode => Object.hash(runtimeType,v,matchId,accepted,offset,snapshot,const DeepCollectionEquality().hash(events),reason);

@override
String toString() {
  return 'WireCommandAck(v: $v, matchId: $matchId, accepted: $accepted, offset: $offset, snapshot: $snapshot, events: $events, reason: $reason)';
}
...
@useResult
$Res call({
 int v, String matchId, bool accepted, int offset, WireSnapshot snapshot, List<Map<String, dynamic>> events, String? reason
});
...
/// Create a copy of WireCommandAck
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? v = null,Object? matchId = null,Object? accepted = null,Object? offset = null,Object? snapshot = null,Object? events = null,Object? reason = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int v,  String matchId,  bool accepted,  int offset,  WireSnapshot snapshot,  List<Map<String, dynamic>> events,  String? reason)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WireCommandAck() when $default != null:
return $default(_that.v,_that.matchId,_that.accepted,_that.offset,_that.snapshot,_that.events,_that.reason);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int v,  String matchId,  bool accepted,  int offset,  WireSnapshot snapshot,  List<Map<String, dynamic>> events,  String? reason)  $default,) {final _that = this;
switch (_that) {
case _WireCommandAck():
return $default(_that.v,_that.matchId,_that.accepted,_that.offset,_that.snapshot,_that.events,_that.reason);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int v,  String matchId,  bool accepted,  int offset,  WireSnapshot snapshot,  List<Map<String, dynamic>> events,  String? reason)?  $default,) {final _that = this;
switch (_that) {
case _WireCommandAck() when $default != null:
return $default(_that.v,_that.matchId,_that.accepted,_that.offset,_that.snapshot,_that.events,_that.reason);case _:
  return null;
...
class _WireCommandAck extends WireCommandAck {
  const _WireCommandAck({this.v = kProtocolVersion, required this.matchId, required this.accepted, required this.offset, required this.snapshot, final  List<Map<String, dynamic>> events = const <Map<String, dynamic>>[], this.reason}): _events = events,super._();
...
@override
int get hashCode => Object.hash(runtimeType,v,matchId,accepted,offset,snapshot,const DeepCollectionEquality().hash(_events),reason);
...
/// Create a copy of WireCommandAck
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? v = null,Object? matchId = null,Object? accepted = null,Object? offset = null,Object? snapshot = null,Object? events = null,Object? reason = freezed,}) {
