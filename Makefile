...
.PHONY: rust-security-policy-test rust-security-policy-check rust-security-tool-versions rust-mutation-check rust-fuzz-smoke rust-miri-check rust-engine-security-check rust-engine-completion-check
...
rust-engine-security-check: rust-mutation-check rust-fuzz-smoke rust-miri-check

successor-engine-check: rust-tool-versions p0-check rust-check rust-architecture-check rust-dependency-check rust-determinism-check rust-security-policy-check
...
rust-engine-completion-check: successor-engine-quality-check rust-test-release rust-foundation-check rust-integrated-turn-check rust-ai-strength-check rust-persistence-check rust-engine-security-check
