...
.PHONY: godot-toolchain-check terrain3d-check godot-terrain-compile
...
.PHONY: successor-map-contract-test successor-flutter-dependencies successor-flutter-format-check successor-flutter-analyze successor-flutter-test successor-flutter-check successor-flutter-device-test successor-flutter-run godot-map-bundle-check map-stage-1-check stage-1-visual-evidence
...
p0-check: legacy-freeze dependency-boundaries successor-boundary-test
